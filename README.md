...
이 저장소는 2024-07-18時点의 코드를 보유한 아카이브되었습니다.
...
local-chat-vrm은 반환 문장의 생성과 읽음소리 생성을 브라우저에서 실행할 수 있는 애플리케이션입니다. 그러나 응답은 영어로만 지원하며 일본어는 사용できません。
...
패키지의 설치가 완료된 후, 다음 명령어로 개발용 웹 서버를 시작합니다.
```bash
npm run dev
```
...
ChatGPT API의仕様과 이용 규약에 대한 내용은 다음 링크와 공식 사이트를 참조해 주세요.
...
## Koeiromap API
ChatVRM은 읽음소리 생성에 Koemotion의 Koeiromap API를 사용합니다.

Koeiromap API의仕様과 이용 규약에 대한 내용은 다음 링크와 공식 사이트를 참조해 주세요.
